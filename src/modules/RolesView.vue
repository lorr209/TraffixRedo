					...
					<tbody>
						...
						>
							...
							<td @mouseover="handleMouseOver(2)">
								<span v-for="m in r.moduli" :key="m" class="tag-modulo">{{
									m
								}}</span>
							</td>
						</tr>
			...
			<div class="bar-body" v-if="ruoloInModifica">
				...
				<div class="form-group">
					...
					<input
						...
						@input="
							(e) =>
								(ruoloInModifica.moduli = e.target.value
									.split(',')
									.map((s) => s.trim()))
						"
					/>
			...
			ruoli.value = [
				{
					id: 1,
					nome: "Amministratore",
					descrizione: "Accesso totale al sistema",
					moduli: ["Utenti", "Dashboard", "Impostazioni"],
				},
				{
					id: 2,
					nome: "Ufficio_Smart",
					descrizione: "Gestione sensori cittadini",
					moduli: ["Mappe", "Sensori"],
				},
				{
					id: 3,
					nome: "Operatore",
					descrizione: "Solo visualizzazione dati",
					moduli: ["Dashboard"],
				},
			];
		}
